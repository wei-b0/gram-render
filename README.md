...
<p align="center">
  <img alt="gram-render vs an LLM, same prompt · same data · same schema: JEV finishes composing in under a second while the LLM is still streaming" src="https://raw.githubusercontent.com/wei-b0/gram-render/main/assets/compare.gif">
</p>
